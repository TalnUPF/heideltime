...
public class HeidelTime extends JCasAnnotator_ImplBase {
	...
	//english, englishcoll, englishsci, german, dutch, vietnamese, arabic, spanish, italian, french, etc.
    ...
    //news, narratives, scientific, colloquial
    ...
    @ConfigurationParameter(name = PARAM_GROUP, mandatory = false, description = "Sets whether or not durations with a smaller granularity can be losslessly converted to a larger granularity, e.g. P24H =&gt; P1D")
    ...
    @ConfigurationParameter(name = PARAM_DEBUG, mandatory = false, description = "Sets whether or not HeidelTime will output DEBUG level information (very noisy)")
