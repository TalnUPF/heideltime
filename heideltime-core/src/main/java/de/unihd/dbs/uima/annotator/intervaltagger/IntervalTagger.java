...
public class IntervalTagger extends JCasAnnotator_ImplBase {
    ...
    @ConfigurationParameter(name = PARAM_INTERVALS, mandatory = false, description = "Whether or not to annotate intervals")
    protected Boolean findIntervals = true;

	public final static String PARAM_INTERVAL_CANDIDATES = "findIntervalCandidates";
    @ConfigurationParameter(name = PARAM_INTERVAL_CANDIDATES, mandatory = false, description = "Whether or not to annotate interval candidates")
