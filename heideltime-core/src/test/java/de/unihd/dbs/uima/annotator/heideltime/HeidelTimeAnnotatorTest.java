...
public class HeidelTimeAnnotatorTest {
    ...
    public void testUDPipeEn() throws Exception {
		...
		String xmiPath = "src/test/resources/udpipe/paleolithic_input.xmi";
		String typesystemPath = "src/test/resources/udpipe/TypeSystem.xml";
		...
		AnalysisEngine writer = AnalysisEngineFactory.createEngine(
				XmiWriter.class,
				XmiWriter.PARAM_TARGET_LOCATION, "src/test/resources/udpipe/paleolithic_actual.xmi",
